...
public class SearchVideoActivity extends BaseAppCompatActivity implements RecycleViewItemClickListener {
    ...
    public void onSuccess(JSONObject object, String method) {
        ...
        try {
            ...
            switch (method) {
                case API.SEARCH:
                    List<LiveInfo> data = gson.fromJson(object.getJSONObject("object").getJSONObject("liveVideo").getJSONArray("list")
                                    .toString(),
                    ...
                    isLast = object.getJSONObject("object").getJSONObject("liveVideo").getInt("isLast");
