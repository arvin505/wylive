 ...
 */
@LayoutId(R.layout.activity_share_weibo)
public class ShareWeiboActivity extends BaseAppCompatActivity implements IWeiboHandler.Response {
    ...
    private void shareWeibo() {
        // 创建微博分享接口实例
        weiboApi = WeiboShareSDK.createWeiboAPI(this, Constants.WB_APP_KEY);
        // 注册第三方应用到微博客户端中，注册成功后该应用将显示在微博的应用列表中。
        // 但该附件栏集成分享权限需要合作申请，详情请查看 Demo 提示
        // NOTE：请务必提前注册，即界面初始化的时候或是应用程序初始化时，进行注册
        weiboApi.registerApp();
        mAuthInfo = new AuthInfo(mContext, Constants.WB_APP_KEY, Constants.WB_REDIRECTURL, Constants.WB_APP_SCOPE);
    ...
    private void loadData() {
        ...
        sendHttpRequest(API.AFTER_SHARE,params);
    }
