...
/**
 * Created by zhaosentao on 2016/9/19.
 */
public class WeiboLoginLinearLayout extends LinearLayout implements View.OnClickListener{
    ...
    public WeiboLoginLinearLayout(Context context) {
        this(context, null);
    }

    public WeiboLoginLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WeiboLoginLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
