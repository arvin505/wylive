...
public class SubmitGradesActivity extends BaseAppCompatActivity {
    ...
    LinearLayout llBack;
    @BindView(R.id.submitGradesTv)
    TextView tvSubmit;
    @BindView(R.id.etRemark)
    EditText etRemark;
    @BindView(R.id.tvWords)
    TextView tvWords;
    @BindView(R.id.ivSubmitGrades)
    ImageView ivSubmitGrades;
    @BindView(R.id.ivSubmitCamera)
    ...
    private void submitGrade() {
        ...
        if (user != null) {
            ...
            sendHttpRequest(API.BOUNTY_UPGRADE,map);
        } else {
    ...
    public void onSuccess(JSONObject object, String method) {
        ...
        if (method.equals(API.BOUNTY_UPGRADE)) {
        ...
        try {
           ...
           // showLoading();
            ...
            new Thread(new Runnable() {
                @Override
                public void run() {
                    FileUploadUtil.uploadImageFile(API.HOST + API.UPLOAD_PIC, null, fileParams, mHandler);
                }
            }).start();
        } catch (Exception e) {
            e.printStackTrace();
                 ...
                 //   hideLoading();
                    try {
                        ...
                        if (!TextUtils.isEmpty(object.getString("object").toString())) {
                            ...
                            if (isCamera) {
                                AsyncImage.displayImage( imgName , ivSubmitCamera);
                            } else {
                                AsyncImage.displayImage( imgName , ivSubmitGrades);
                            }
    ...
    private SpannableStringBuilder addconnent(String cotent1, String content2, String content3) {
        ...
        ssb.setSpan(new ClickableSpan() {
            ...
            public void updateDrawState(TextPaint ds) {
                ...
                ds.setColor(context.getResources().getColor(R.color.bar_text_selected));// 设置文本颜色
                // 去掉下划线
