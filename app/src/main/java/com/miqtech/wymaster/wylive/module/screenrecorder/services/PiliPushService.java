package com.miqtech.wymaster.wylive.module.screenrecorder.services;
...
import com.miqtech.wymaster.wylive.module.screenrecorder.core.ScreenRecorder;
...
public class PiliPushService extends Service implements ScreenRecorder.ScreenRecorderListener, StreamingStateListener {
    ...
    public void setParams(Activity activity, int videoWidth, int videoHeight, int densityDpi, int orientation, int bitRate, String pushUrl) {
        ...
        mPushUrl = pushUrl;
        initStreamManager();
        statusHeight = DeviceUtils.deviceStatusHeight(mActivity);
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
       ...
       /* Notification notification = new Notification();
        ...
        mNManager.notify(0,notification);*/
        ...
        imageButton.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    int x = DeviceUtils.deviceWidth(PiliPushService.this) - imageButton.getMeasuredWidth() / 2;
